...
namespace restaurant_management_system
{
    public partial class CashierOrderForm : UserControl
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\moham\Documents\Restaurant.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            using (SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\moham\Documents\Restaurant.mdf;Integrated Security=True;Connect Timeout=30"))
            {
                connect.Open();
